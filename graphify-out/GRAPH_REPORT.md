# Graph Report - Autominder  (2026-08-22)

## Corpus Check
- cluster-only mode — file stats not available

## Summary
- 1974 nodes · 4216 edges · 128 communities (103 shown, 25 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 79 edges (avg confidence: 0.85)
- Token cost: 7,792 input · 1,385 output

## Graph Freshness
- Built from commit: `33a807f6`
...
- Project Risks and Logic
- Fuel Entry ViewModel
- Premium Spending Charts
- Service History ViewModel
- Reminder Repository Interface
- Reminder Data Access
- Service Data Repository
- Vehicle Data Access
- Fuel History ViewModel
- Mileage Repository Module
- Dashboard Data UseCase
- Design System Research
- Service Save Logic Tests
- Add Fuel Screen
- Service Data Access
- Reminder Urgency Types
- Due Date Prediction
...
- Quote Triage Workflow
- Development Governance and QA
- Default Reminder Generation
- Reminder Ranking Logic
- Dashboard ViewModel
- Mileage Log UI
- Vehicle List Tests
- Settings and Edit Screens
- Vehicle Detail Cards
- Common UI States
- Onboarding UI Components
- Reminder Editor ViewModel
- Play Store Release Checklist
- Brand and Design System
- Project Setup and Policy
- Backup and Dispatchers
- Add Reminder ViewModel
- Service Repository Implementation
- App Lifecycle & Initialization
- Reminder Priority Engine
- Driving Amount Configuration
- AutoMinderWidget.kt
- Status and Digest Workers
- Localization and Workers
- Service Export UseCase
...
- Onboarding Flow ViewModel
- Vehicle Catalog Tests
- UI Audit and Accessibility
- Accessibility and UI Rules
- Architecture and Security Laws
- Vehicle Operational Status
- UserPreferences
- Fuel Efficiency UI
- Service History UI
- Vehicle Selection Sheets
- Notification Action Receiver
- Reminder Alarm Tests
- Maintenance Section Utilities
- About Screen UI
- Fuel Efficiency Calculation
- Overdue Text Tests
- Release Backlog and Slices
- Android Test Runner
- Add Vehicle ViewModel
- Privacy and Store Listings
- Quick Log UI
- Play Store Launch Scorecard
- Recent Activity UI
...
- Notification Permission Utils
- Service Type Icons
- Baseline Profile Generator
- Firebase MCP Config
- Play Store Description
- Play Store Title
- Figma Integration Lessons
...
### Community 4 - "Service Entry Events"
Cohesion: 0.12
...
### Community 8 - "Input Validation Logic"
Cohesion: 0.08
...
### Community 9 - "Project Risks and Logic"
Cohesion: 0.16
...
### Community 10 - "Fuel Entry ViewModel"
Cohesion: 0.11
...
### Community 11 - "Premium Spending Charts"
Cohesion: 0.05
...
### Community 13 - "Reminder Repository Interface"
Cohesion: 0.20
Nodes (5): toDomain(), toEntity(), Reminder, IReminderRepository, Flow

### Community 14 - "Reminder Data Access"
Cohesion: 0.16
Nodes (3): Flow, ReminderDao, ReminderEntity

### Community 15 - "Service Data Repository"
Cohesion: 0.16
Nodes (5): Service, IServiceRepository, Flow, ExportServiceHistoryUseCaseTest, Context

### Community 16 - "Vehicle Data Access"
Cohesion: 0.16
Nodes (3): Flow, VehicleDao, VehicleEntity

### Community 17 - "Fuel History ViewModel"
Cohesion: 0.19
...
### Community 18 - "Mileage Repository Module"
Cohesion: 0.06
...
### Community 36 - "Manual Backup Management"
Cohesion: 0.30
...
### Community 37 - "Vehicle Status Cards"
Cohesion: 0.15
...
### Community 39 - "Quote Triage Workflow"
Cohesion: 0.18
...
### Community 40 - "Development Governance and QA"
Cohesion: 0.19
...
### Community 41 - "Default Reminder Generation"
Cohesion: 0.19
...
### Community 46 - "Settings and Edit Screens"
Cohesion: 0.24
Nodes (10): Modifier, pressScale(), EditVehicleField(), EditVehicleForm(), EditVehiclePhotoHero(), EditVehicleScreen(), ImageVector, KeyboardType (+2 more)

### Community 47 - "Vehicle Detail Cards"
Cohesion: 0.25
Nodes (13): FormSectionCard(), Modifier, CompactContent(), ExpandedContent(), androidx, Color, Modifier, VehicleAvatar() (+5 more)

### Community 48 - "Common UI States"
Cohesion: 0.14
Nodes (25): labelRes(), EmptyState(), ImageVector, Modifier, ErrorState(), Modifier, ListSkeleton(), QuoteAuditorScreen() (+17 more)

### Community 49 - "Onboarding UI Components"
Cohesion: 0.29
Nodes (16): GlowHero(), Color, ImageVector, Modifier, OnboardingProgressBar(), PillarItem, PrimaryCta(), ValuePillarGroup() (+8 more)

### Community 50 - "Reminder Editor ViewModel"
Cohesion: 0.12
...
### Community 51 - "Play Store Release Checklist"
Cohesion: 0.15
...
### Community 54 - "Backup and Dispatchers"
Cohesion: 0.10
...
### Community 66 - "Product Strategy Review"
Cohesion: 0.17
...
### Community 67 - "UI Component Specifications"
Cohesion: 0.18
...
### Community 77 - "UI Architecture Rules"
Cohesion: 0.20
...
### Community 78 - "Onboarding Flow ViewModel"
Cohesion: 0.24
Nodes (4): StateFlow, ViewModel, OnboardingUiState, OnboardingViewModel

### Community 80 - "UI Audit and Accessibility"
Cohesion: 0.22
...
### Community 81 - "Accessibility and UI Rules"
Cohesion: 0.28
...
### Community 82 - "Architecture and Security Laws"
Cohesion: 0.22
...
### Community 83 - "Vehicle Operational Status"
Cohesion: 0.29
...
### Community 85 - "Fuel Efficiency UI"
Cohesion: 0.38
...
### Community 86 - "Service History UI"
Cohesion: 0.47
...
### Community 90 - "Maintenance Section Utilities"
Cohesion: 0.14
...
### Community 98 - "Privacy and Store Listings"
Cohesion: 0.31
...
### Community 99 - "Quick Log UI"
Cohesion: 0.67
Nodes (5): Color, ImageVector, Modifier, QuickLogButton(), QuickLogSection()

### Community 101 - "Play Store Launch Scorecard"
Cohesion: 0.29
...
### Community 135 - "Efficiency Trend Logic"
Cohesion: 0.40
